...
@section('content')
    ...
    <div class ="card border">
        <div class="card-body">
            ...
            <form action="{{route('dadosPagina3')}}" method="POST"></form>
                @csrf
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
                <div class="form-group py-4">
                    <label for="pergunta"> <h3> <strong> em 2022 quais músicas da banda tiveram mais visualizações? </strong> </h3> </label>
                    <div class="form-check py-4">
                        <input class="form-check-input" type="radio" name="pergunta" id="pergunta" value="A">
                        <label class="form-check-label" for="pergunta">
                            <h5> Cirici e Con Clavi Con Dio </h5>
                        </label>
                    </div>
